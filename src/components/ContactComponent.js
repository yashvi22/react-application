...
const validEmail=(val)=>/^[A-Z)-9._%+-]+@[A-Z)-9.-]+\.[A-Z]{2,4}$/i.test(val);
...
class Contact extends Component {
    ...
    handleSubmit(values){
        ...
        this.props.postFeedback(values.agree, values.firstname, values.lastname, values.telnum, values.email, values.contactType, values.message,values.id);        
    }
